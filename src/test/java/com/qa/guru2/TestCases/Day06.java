...
public class Day06 {
	 private WebDriver driver;
	  ...
	  public String firstName = "padma";    // These testdata stuff will be placed    
	  public String lastName = "grla";  // in a TestData EXCEL file at some stage
	  public String vEmail = "padmagrla@gmail.com";
	  public String vPW = "test123";
